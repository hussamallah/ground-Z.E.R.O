...
const CURRENT_ARCHETYPE = "Diplomat";
...
export default function DiplomatResultsPage() {
    ...
    <div className="mb-6 pt-6">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-y-4">
            ...
            <div className="flex items-center gap-x-3">
                ...
                <img
                    src={`/${(finalWinner?.face || 'Diplomat').toLowerCase()}.png`}
                    alt={`${finalWinner?.face || 'Diplomat'} emblem.`}
                    width={72}
                    height={72}
                    className="rounded"
                    style={{
                ...
                return (
                    <div
                        ...
                        className={`bg-white/5 rounded-lg p-4 flex flex-col cursor-pointer transition-all duration-200 hover:bg-white/10 ${
                            isPrizeActive ? 'bg-gradient-to-br from-teal-500/10 to-teal-600/5 border border-teal-500/20' : ''
                        }`}
